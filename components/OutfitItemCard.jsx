export function OutfitItemCard({ item, isSelected, onChange, onPreview }) {
  ...
  return (
    <div className={`border rounded-2xl overflow-hidden bg-white shadow-lg hover:shadow-xl transition-shadow flex flex-col h-full ${
      ...
      <div className="p-3 flex flex-col flex-1">
        ...
        {/* Buttons section pinned to bottom */}
        <div>
          <button
